...
p1 <- dbeta(x, alpha1, beta1)
p1 <- p1/sum(p1)

ratio <- (p1/(1-p1))/(p0/(1-p0))

plot(x, p0, type='l', col='red')
lines(x, p1, col='blue')

ratio

sprintf('Posterior odds ratio mean: %f', mean(ratio))
#sprintf('Posterior odds ratio median and 95 pct credible interval for p0: %f, %f', qbeta(c(0.5,0.95), alpha0, beta0))
#sprintf('Posterior odds ratio median and 95 pct credible interval for p1: %f, %f', qbeta(c(0.5,0.95), alpha1, beta1))
```
